...
const DeletionChart = ({ownerN, repoN}) => {
    const owner = ownerN;
    const repo = repoN;
   ...
   let data= {
        ...
        datasets: [{
          label: `${chartData?.length} Deletions`,
          data: chartData?.map(entry => entry.deletions),
    ...
    let options= {
        ...
        plugins:{
            ...
            title:{
                display: true, text:"Deletions in Repository"
            },
            tooltip: { 
                mode: 'nearest',
                intersect: false,
                callbacks: {
                    ...
                    label: function (context) {
                      return `Deleted: ${context.formattedValue}`;
                    }
                  }
              },
        },
